...
async def upload_document(file: UploadFile = File(...)):
    ...
    if is_image:
        ...
        status = DocumentStatus.CONCLUIDO if valid else DocumentStatus.PENDENTE_CORRECAO

    elif is_pdf:

        status = DocumentStatus.PENDENTE_CORRECAO
    ...
    """, (
        ...
        str(document.type.value),   # Use o .value para pegar a string "passaporte", etc.

        str(document.status.value), # Use o .value para pegar "CONCLUIDO", etc.
